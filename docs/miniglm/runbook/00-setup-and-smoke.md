...
如果你的目标是训练 Mini-GLM，而不是只验证当前 MiniMind 链路，请先完成 [../00-engineering-migration.md](../00-engineering-migration.md)。没有完成工程改造前，本文件里的 Mini-GLM 目标命令不可执行。
